...
| Test                        | Result   | Expected Result | Final Status           |
|-----------------------------|----------|-----------------|------------------------|
| FPS (Category 1)            | ~195 FPS | 120+ FPS        | Pass ✅               |
| FPS (Category 2)            | ~148 FPS | 100+ FPS        | Pass ✅               |
| FPS (Category 3)            | ~110 FPS | 80+ FPS         | Pass ✅               |


| Test                         | Result   | Expected Result | Final Status           |
|------------------------------|----------|-----------------|------------------------|
| 1% Low with FPS (Category 1) | 33 FPS   | 30+ FPS         | Pass ✅               |
| 1% Low with FPS (Category 2) | 26 FPS   | 25+ FPS         | Pass ✅               |
| 1% Low with FPS (Category 3) | 25 FPS   | 20+ FPS         | Pass ✅               |
